...
| 🔍 Step 1 问题深析 | 🎭 Step 2 人设锻造 | 💬 Step 3 人设应答 | ✅ Step 4 质量自检 |
|:---|:---|:---|:---|
| 深度解析用户问题 | 生成与问题最匹配的严谨人设 | 以人设视角精准回答 | 5 项自检确保输出质量 |
| 提取核心诉求、领域、语境 | 定义身份、知识体系、思维框架 | 全程保持人设一致性和专业性 | 不通过则修正重出 |
...
```
用户提问 → 问题深析 → 人设锻造(含人设预览) → 人设应答 → 质量自检(5 项)
```
